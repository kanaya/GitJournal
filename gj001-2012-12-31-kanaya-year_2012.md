...
Exploring Kansei of Design by Scientific Eyes.
...
symposium, which was hosted by National Academy of Enigneering (NAE),
...
traditional X Engineering (X = Eleectric, Mechanical, Bio, ...), and
...
29-31, 2012, at the Arnold and Mabel Beckman Center in Irvine,
...
[my blog entry](http://blog.pineapple.cc/post/37825040981)

## 5.7 Talk at Japan Foundation

A misterious lady in ancient Egypt.

## 5.8 CoreVideo.net

[CoreVideo.net](http://corevideo.net)
...
The [main web site](http://www.pineapple.cc) has got a simple view
(again). It had been hosted on Blogger but now on a regular web
...
My [pineapple blog](http://blog.pineapple.cc) has been hosted on
Tumblr and this won't be changed, except for its URL.
...
in the first quater if this will happen. A new URL will be given to
the Wiki sites.
...
[CoreVideo.net](http://www.corevideo.net), and maybe
[GeekPort](http://geekport.pineappledesign.org).
