...
switchable), one EXT connector (5V-in, GND, 3.3V-out, 1 USB, 1
Serial/I2C, 1 SPI, 1 PWM out), four sensor connectors (each connector
has 1 5V-out, 1 3.3V-out, 1 GND, 1 sensor-in, 1 monitor-out, and 1
